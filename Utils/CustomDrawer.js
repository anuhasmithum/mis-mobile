            ...
            <View style={styles.container}>
                ...
                <View style={styles.screenContainer}>
                    <View style={[styles.screenStyle, (this.props.activeItemKey == 'Dashboard1') ? styles.activeBackgroundColor : null]}>
                        ...
                        <Text style={[styles.screenTextStyle, (this.props.activeItemKey == 'Dashboard1') ? styles.selectedTextStyle : null]} onPress={this.navigateToScreen('Dashboard1')}>Home</Text>
                    </View>
